...
/*
*
* This class contains a few methods that are used during the rendering of certain things.
*
* */
...
public class GLSettings {
	...
	public static void setDepthTesting(boolean enable){
	...
	public static void setWireframe(boolean goWireframe) {
