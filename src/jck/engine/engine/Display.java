...
public class Display {
	...
	//This methods creates the display using a display builder.
	...
	//This methods disposes the display
	...
	//This method checks if the display is focued on by the user.
	public static boolean isActive() {
		return GLFW.glfwGetWindowAttrib(id, GLFW.GLFW_FOCUSED) == 1;
	}

	//This methods swaps the buffers of the display (In processing background(0);)
	...
	//With this method u can get the fps.
